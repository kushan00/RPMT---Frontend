...
const ReqSup = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (data) => (
        <div>
          <Button className="btn btn-warning" onClick={() => assignStaff(data)}>
            Request
          </Button>
        </div>
      ),
            ...
            <div style={{ width: "400px" }}>
              <Form>
                ...
                <Input
                  ...
                  value={Group_Leader_ITNUM}
                  onChange={(e) => handleGroup_Leader_ITNUM(e)}
                />
                <br />
                ...
                <Input
                  ...
                  value={Group_Reg_NUM}
                  onChange={(e) => handleGroup_Reg_Num(e)}
                />
                <br />
                <Button
                  className="btn btn-success"
                  onClick={(e) => requestSupervisor(e)}
                >
                  Request
                </Button>
              </Form>
