...
const StudentTitleBar = ({ auth: { user } }) => {
			...
			<div className="sidebar" >
				<div className="sidebarWrapper">
					<div className="sidebarMenu">
						<div className="sidebarTitle">Student's Dashboard</div>
...
export default connect(mapStateToProps)(StudentTitleBar);
